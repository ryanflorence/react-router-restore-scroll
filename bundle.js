...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRouterApplyMiddleware = __webpack_require__(216);
	
	var _reactRouterApplyMiddleware2 = _interopRequireDefault(_reactRouterApplyMiddleware);
	
	var _reactRouterRestoreScroll = __webpack_require__(217);
	...
	var Index = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _reactRouterRestoreScroll.RestoreScroll,
	        { scrollKey: 'one' },
	        _react2.default.createElement(
	          'div',
	...
	(0, _reactDom.render)(_react2.default.createElement(_reactRouter.Router, {
	  render: (0, _reactRouterApplyMiddleware2.default)((0, _reactRouterRestoreScroll.useRestoreScroll)()),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RestoreScroll = exports.useRestoreScroll = undefined;
	...
	function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; } /*eslint no-console: 0*/
	...
	var useRestoreScroll = exports.useRestoreScroll = function useRestoreScroll() {
	  return {
	    renderRootContainer: function renderRootContainer(props) {
	      return _react2.default.createElement(RestoreScrollContainer, props);
	    }
	  };
	};
	...
	var RestoreScrollContainer = _react2.default.createClass({
	  displayName: 'RestoreScrollContainer',
	  ...
	  getChildContext: function getChildContext() {
	    ...
	    return { restoreScroll: {
	        registerScroller: function registerScroller(scrollKey, component) {
	          console.log('registerScroller', scrollKey);
	          _this.scrollers[scrollKey] = component;
	        },
	        unregisterScroller: function unregisterScroller(scrollKey) {
	          console.log('unregisterScroller', scrollKey);
	          delete _this.scrollers[scrollKey];
	        },
	  ...
	  getPosition: function getPosition(scrollKey) {
	    var positionsByLocation = this.positionsByLocation;
	    var key = this.props.location.key;
	
	    var locationPositions = positionsByLocation[key];
	    return locationPositions ? locationPositions[scrollKey] || null : null;
	  },
	  savePosition: function savePosition(scrollKey, position) {
	    console.log('savePosition', scrollKey, position);
	    this.positionsByLocation[this.props.location.key][scrollKey] = position;
	  },
	  saveScrollerPositions: function saveScrollerPositions() {
	    ...
	    if (!positionsByLocation[key]) positionsByLocation[key] = {};
	
	    var _window = window;
	    var scrollY = _window.scrollY;
	    var scrollX = _window.scrollX;
	
	    this.savePosition('window', { scrollX: scrollX, scrollY: scrollY });
	
	    for (var scrollKey in scrollers) {
	      var scrollerNode = scrollers[scrollKey];
	
	      var _findDOMNode = (0, _reactDom.findDOMNode)(scrollerNode);
	
	      var scrollTop = _findDOMNode.scrollTop;
	      var scrollLeft = _findDOMNode.scrollLeft;
	
	      this.savePosition(scrollKey, { scrollTop: scrollTop, scrollLeft: scrollLeft });
	    }
	  },
	  componentDidUpdate: function componentDidUpdate(prevProps) {
	    if (prevProps.location !== this.props.location) {
	      var position = this.getPosition('window');
	      if (position) {
	  ...
	  render: function render() {
	    ...
	    var props = _objectWithoutProperties(_props, ['render']);
	
	    return render(props);
	  }
	});
	
	var RestoreScroll = exports.RestoreScroll = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    var registerScroller = this.context.restoreScroll.registerScroller;
	    var scrollKey = this.props.scrollKey;
	
	    registerScroller(scrollKey, this);
	    this.restoreScrollPosition();
	  },
	  componentWillUnmount: function componentWillUnmount() {
	    var unregisterScroller = this.context.restoreScroll.unregisterScroller;
	    var scrollKey = this.props.scrollKey;
	  ...
	  restoreScrollPosition: function restoreScrollPosition() {
	    var scrollKey = this.props.scrollKey;
	    var getPosition = this.context.restoreScroll.getPosition;
	
	    var position = getPosition(scrollKey);
	    if (position) {
